...
export default function SearchData() {
  ...
  return (
    <div className="space-y-6">
      ...
      {tabelex.dipartment === "accountant" || selectedTask==="onboarding-data" ? (
        ""
      ) : (
            ...
            <Table className="w-full" style={{ pageBreakAfter: "always" }}>
              ...
              <TableBody>
                ...
                <TableRow className="border text-lg">
                  ...
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
                    15 min buffer time for late coming as per your schedule time
                    , 3 LATE = 1 half day
                  </TableCell>
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
                ...
                <TableRow className="border text-lg">
                  ...
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
                    Proper Response to be given by allthe Phones Handling team
                    on realtime
                  </TableCell>
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
            ...
            <Table className="w-full">
              <TableBody>
                <TableRow className="h-[80px] text-lg">
                  ...
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
                    No leaves are allowed during the training period of 1st 6
                    Days
                  </TableCell>
                </TableRow>
                ...
                <TableRow className="h-[80px] text-lg">
                  ...
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
                    ...
                    conducted by the trainer or the Manager. Failing on
                    assessment before the OJT (On-the-Job)
                  </TableCell>
                </TableRow>
                <TableRow className="h-[80px] text-lg">
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
                  ...
                  <TableCell className="xyx whitespace-pre-line break-words border text-black">
                    Upon unsuccessful Assessment - 6 days Training period will
                    be paid only of Rs- 1500/-
                  </TableCell>
                </TableRow>
                <TableRow className="h-[80px] text-lg">
                  <TableCell
                    ...
                    colSpan={2}
                  >
                    * Upon successful completion of Training and Assessment you
                    will be assigned to your designated team as per the process
                    requirements and that will be the starting day of your
                    discussed salary. OJT will be for 90 days , Salary may vary
                    on your OJT performance *
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
